...
Public Class LastDetailSalary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.LastDetailSalary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLastDetailSalary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LastDetailSalary = New LastDetailSalary()
        rpt.Site = Me.Site
        Return rpt
    End Function
