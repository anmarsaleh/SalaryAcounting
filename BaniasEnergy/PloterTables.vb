...
Public Class PloterTables
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.PloterTables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPloterTables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PloterTables = New PloterTables()
        rpt.Site = Me.Site
        Return rpt
    End Function
