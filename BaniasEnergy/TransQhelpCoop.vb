...
Public Class TransQhelpCoop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.TransQhelpCoop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTransQhelpCoop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TransQhelpCoop = New TransQhelpCoop()
        rpt.Site = Me.Site
        Return rpt
    End Function
