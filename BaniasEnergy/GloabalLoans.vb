...
Public Class GloabalLoans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.GloabalLoans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGloabalLoans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GloabalLoans = New GloabalLoans()
        rpt.Site = Me.Site
        Return rpt
    End Function
