...
Public Class DetailEmpSalary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.DetailEmpSalary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDetailEmpSalary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DetailEmpSalary = New DetailEmpSalary()
        rpt.Site = Me.Site
        Return rpt
    End Function
