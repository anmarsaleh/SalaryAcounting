...
Public Class RecoverBackRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.RecoverBackRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRecoverBackRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RecoverBackRpt = New RecoverBackRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
