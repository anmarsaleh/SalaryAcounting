...
Public Class TransMergRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BaniasEnergy.TransMergRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTransMergRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TransMergRpt = New TransMergRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
